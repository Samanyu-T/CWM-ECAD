...
create_ip -name blk_mem_gen -vendor xilinx.com -library ip -version 8.4 -module_name ColourFinal_BRAM
set_property -dict [list CONFIG.Component_Name {ColourFinal_BRAM} CONFIG.Write_Width_A {24} CONFIG.Write_Depth_A {8} CONFIG.Read_Width_A {24} CONFIG.Write_Width_B {24} CONFIG.Read_Width_B {24} CONFIG.Load_Init_File {true} CONFIG.Coe_File {/home/centos/CWM-ECAD/Ex6/mem.coe} CONFIG.Fill_Remaining_Memory_Locations {false}] [get_ips ColourFinal_BRAM]
